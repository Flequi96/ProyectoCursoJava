...
<body class="landing is-preload">
	...
	<div id="page-wrapper">
		...
		<header id="header" class="alt">
			<span class="image logo"><a href="index.jsp"><img
						...
						<ul>
							...
							<li><a href="#juegos">Juegos</a>
								<ul>
									...
									<li><a href="art.league.html">League of Leguends</a></li>
			...
			<section class="box special">
				<header class="major">
					...
					<p>
						...
						tiempo y ganas<br /> para así satisfacer las necesidades de los
				...
				<div class="features-row">
					...
					<section>
						...
						<p>El nuevo battle royale que con el poco tiempo que lleva
							destaca como el que más.</p>
					</section>
				</div>
				<div class="features-row">
					<section>
						<a href="art.league.html"><img src="images/league.jpg" width="100%" height="100%" /></a>
			...
			<div class="row">
				<div class="col-6 col-12-narrower">
					...
					<section class="box special">
						...
						<ul class="actions special">
							<li><a href="#" class="button alt">Click para más info</a></li>
						</ul>
					</section>
      ...
      -->
		...
		<footer id="footer">
			<div id="overbox3">
				<div id="infobox3">
					<p>
						Esta web utiliza cookies. Si continúas navegando consideramos
						que aceptas su uso. <a target="_blank"
							href="http://www.interior.gob.es/politica-de-cookies">Más
			...
			<div class="paypal">
				<h4>Si te gusta nuestra web, ayudanos a manetenerla, haz una
					pequeña donación , para nosotros es una gran colaboración.</h4>
			</div>
			<ul class="icons">

				<li><a target="_blank" id="paypal" href="https://paypal.me/pools/c/8cJ2uie8VW"><img
